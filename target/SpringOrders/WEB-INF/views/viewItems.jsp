...
<%@ page import="java.util.List,com.app.model.Items,com.app.model.OrderItems"%>
			...
			<c:forEach items="${list}" var="orderItems">
				...
				<div class="card h-100">
				 <img src="img/${orderItems.items.itemId}.jpg" alt="Items"
						...
						<p>
						Price :${orderItems.items.itemPrice}
						</p>
					<p>
						Quantity :
						${orderItems.quantity}
					...
					<div class="d-flex align-items-center">
						<a href="oiedit?id=${orderItems.id}">Edit</a> <a
							href="<c:url value='/oidelete-${orderItems.id}'/>">Delete</a>
					</div>
				</div>
			</div>
			</c:forEach>
